...
@Repository
public interface MerchantBalanceRepository extends ReactiveCrudRepository<MerchantBalance, String> {
    ...
    @Query("UPDATE merchant_balances SET available_balance = available_balance - :amount, total_withdrawn = total_withdrawn + :amount, updated_at = CURRENT_TIMESTAMP WHERE merchant_id = :merchantId AND available_balance >= :amount")
